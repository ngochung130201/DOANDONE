...
namespace Share.ViewModels
{
    public class ProductVM
    {
       ...
       // public string ?Slug { get; set; } // slug 
        ...
        public DateTime UpdateDate { get; set; } = DateTime.Now; // Ngày cập nhật 
        public Guid? CateID { get; set; } // khóa ngoại
        public Guid? Supplierid { get; set;} // Khóa ngoại nhà cung câps
        //public ProductCategoryVM ?ProductCategory { get; set; } // danh mục sản phẩm
        //public SupplierVM? Supplier { get; set; } // Nhà cung cấp
        //public BrandVM? Brand { get; set; } // Thương hiệu
